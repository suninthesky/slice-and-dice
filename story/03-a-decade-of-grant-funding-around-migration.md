...
Going beyond conventional funding themes around issue or sector, [next]({{ page.next }}) we'll see if **slicing** the data by *Funder* helps us identify leading supporters "core cost" funding...